...
categories: [ai, writing, openclaw]
tags: [jarvis, voice-replication, skills, blog]
...
I discovered I **love** playing with words when I wrote a book about my time working as a safari guide in Africa. I also discovered it's **hard** – a skill that must first be learnt, and then practiced incessantly – obsessively even. I remember hearing that P.G. Wodehouse used to stick his draft pages on the wall of his study. The higher up the wall a page was, the better he deemed the content. Only pages at the picture rail were deemed acceptable.

Anyway, all that to say that when I decided I should try to automate my blog content generation process, I realised I had to have Jarvis writing in a style as close to my voice as possible. Partly professional pride, partly the horror of generating more attention‑grabbing click‑bait AI slop.
...
3. **Non‑technical explanation** – Concepts for general audiences (like explaining evolution)
...
Let's look at one of the example passages Jarvis studies. This is from the "humorous narrative" category – a story about Jasper, a baboon at the rehabilitation centre where I worked:
...
Voice replication isn't just about vanity or preserving stylistic quirks. It's about maintaining authenticity in an age of generated content. When I read something attributed to me, I want it to sound like something I would actually write – not like a committee‑written corporate piece or a click‑bait listicle.

This skill represents a middle ground between full manual writing and completely AI‑generated content. Jarvis handles the heavy lifting – research, structure, initial drafting – but the output feels recognizably mine. It's augmentation rather than replacement.

## The complete skill

For those interested in the technical implementation, the full `author‑voice‑replication` skill markdown is included earlier in this post (see the "Building the skill" section). If you're building something similar for your own AI assistant, that complete code block can serve as a starting point.

Here are a couple of the example passages Jarvis references – the actual text it studies when trying to match my voice:

### humorous-narrative.md (full)
...
### non-technical-explanation.md (excerpt)
