...
Dealing with my OpenClaw agent feels somewhat like owning a combination of racehorse and classic sports car. Both are magnificent and extraordinary, and a delight when they are doing what they're supposed to, but it's sometimes tricky to cajole and wrestle them into that place where they're just right.
...
- **GLM-5** for when you need the big guns. This is like working with a lawyer - don't waste their time on everyday tasks and you won't waste your dollars.
...
- **Browser automation** - direct use of the browser tool is slow and token‑heavy. For one task we ended up writing a Playwright script instead, which works well but reinforces that visual tasks aren't the assistant's forte.
